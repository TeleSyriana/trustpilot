const reviews = [
  ...
  },
  {
    ...
    body: "I initially ordered the wrong item by mistake (iPhone 15 Pro case instead of iPhone 15), but the support team handled it very smoothly. They responded the next day, provided a return label, and qu...",
  ...
  },
  {
    ...
    fullBody: 'Fast delivery and clean packaging. The case looked exactly like the photos and the MagSafe connection feels strong.',
  ...
  },
  {
    ...
    fullBody: 'Support replied eventually, but clearer delivery and returns updates are still needed. The item itself was acceptable.',
...
keywordSearch.addEventListener('input', renderReviews);
filterInputs.forEach(input => input.addEventListener('change', renderReviews));
